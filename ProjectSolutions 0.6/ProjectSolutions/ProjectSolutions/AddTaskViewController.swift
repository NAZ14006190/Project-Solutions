...
class AddTaskViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    // The ID of the project that this task is being added to
    var projectId: Int? // ? means optional
    // The list of task statuses that can be selected
    ...
    @IBAction func addTaskButtonPressed(_ sender: UIButton) {
        // Check that all fields have been filled in
            guard let taskName = taskNameField.text,
                  ...
                  !taskDesc.trimmingCharacters(in: .whitespaces).isEmpty else {
                errorTaskLabel.text = "Please fill in all fields."
                return
            }
        // Convert the selected due date to a string
        ...
        // Serialize the parameters to JSON and add them to the request body
        do {
